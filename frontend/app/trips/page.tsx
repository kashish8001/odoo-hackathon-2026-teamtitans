    ...
    <main className="min-h-screen bg-[#0f1115] px-6 py-6 text-slate-100 md:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <section className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <TripMetric label="Active Trips" value="18" tone="emerald" />
          <TripMetric label="Pending Dispatch" value="7" tone="amber" />
          <TripMetric label="Available Vehicles" value="42" tone="sky" />
          <TripMetric label="On-Time Rate" value="91%" tone="violet" />
        </section>
